...
export const STRINGS: Record<Locale, Record<string, string>> = {
	ar: {
		...
		"surah.title": "فتح ملاحظة سورة",
		"surah.placeholder": "ابحث باسم السورة أو رقمها...",
		"surah.empty": "لم يتم العثور على سورة.",
		"surah.ayahCount": "{count} آية",
		"entry.title": "تسجيل ملاحظة على آية",
		"entry.searchPlaceholder": "ابحث في الآيات أو اكتب جزءاً من نصها...",
		"entry.section": "القسم",
		"entry.rangeEnd": "إلى آية (اختياري)",
		"entry.notePlaceholder": "اكتب ملاحظتك أو تدبرك هنا...",
		"entry.chooseAyah": "اختر آية أولاً.",
		"entry.writeNote": "اكتب ملاحظة أولاً.",
		"entry.save": "تسجيل الملاحظة",
		"entry.failed": "تعذر تسجيل الملاحظة.",
	},
	en: {
		...
		"surah.title": "Open surah note",
		"surah.placeholder": "Search by surah name or number...",
		"surah.empty": "No surah found.",
		"surah.ayahCount": "{count} ayahs",
		"entry.title": "Log note on an ayah",
		"entry.searchPlaceholder": "Search ayahs or type part of the verse...",
		"entry.section": "Section",
		"entry.rangeEnd": "To ayah (optional)",
		"entry.notePlaceholder": "Write your reflection or note here...",
		"entry.chooseAyah": "Choose an ayah first.",
		"entry.writeNote": "Write a note first.",
		"entry.save": "Log note",
		"entry.failed": "The note could not be logged.",
	},
};
